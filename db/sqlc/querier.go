...
type Querier interface {
	...
	CreateTweet(ctx context.Context, arg CreateTweetParams) (CreateTweetRow, error)
	CreateTweetWithImage(ctx context.Context, arg CreateTweetWithImageParams) (CreateTweetWithImageRow, error)
	...
	GetAllTweets(ctx context.Context, limit int32) ([]GetAllTweetsRow, error)
	...
	GetTweetByID(ctx context.Context, id int32) (GetTweetByIDRow, error)
	GetTweetsByIDs(ctx context.Context, dollar_1 []int32) ([]GetTweetsByIDsRow, error)
	GetTweetsByUserID(ctx context.Context, userID int32) ([]GetTweetsByUserIDRow, error)
	GetTweetsByUserIDWithCursor(ctx context.Context, arg GetTweetsByUserIDWithCursorParams) ([]GetTweetsByUserIDWithCursorRow, error)

...
type Querier interface {
	...
	CountUnreadNotificationsByUserID(ctx context.Context, userID int32) (int64, error)
	...
	GetAllTweetsWithCursor(ctx context.Context, arg GetAllTweetsWithCursorParams) ([]Tweet, error)
	...
	GetNotificationsByUserIDWithCursor(ctx context.Context, arg GetNotificationsByUserIDWithCursorParams) ([]Notification, error)
	...
	GetUserLikesWithCursor(ctx context.Context, arg GetUserLikesWithCursorParams) ([]Like, error)
